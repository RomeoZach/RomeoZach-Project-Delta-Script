...
--[[
    ================================================================================
    --|                                                                            |--
    --|    PROJECT DELTA V8 ULTIMATE - PURE COMBAT (CORPSE OPTIMIZED)              |--
    --|                 Author  : RomeoZach                                        |--
    --|                                                                            |--
    ================================================================================
]]
...
local success, err = pcall(function()
    ...
    task.spawn(function()
        while task.wait(1.5) do 
            ...
            -- Mengizinkan pemindaian folder di workspace untuk mencegah mayat player/AI terlewat
            local loopCount = 0
    ...
    RunService:BindToRenderStep("RomeoZach_Render", 2005, function(deltaTime)
        ...
        for entity, box in pairs(ESP_Objects) do
            ...
            -- Mengamankan Adornee secara berkala jika rootPart awal hancur/jatuh menembus map
            ...
            if isDead then
                -- FIX JARAK JANGKAUAN MAYAT: 357.1429 (100 Meter)
