...
local success, errorMessage = pcall(function()
    ...
    RunService:BindToRenderStep("RomeoZach_Render", 2005, function(deltaTime)
        ...
        -- C. KENDALI UTAMA ENGINE AIMLOCK
